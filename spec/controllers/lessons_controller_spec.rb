  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved lesson as @lesson" do
        ...
        post :create, {:lesson => { "name" => "invalid value" }}, valid_session
        assigns(:lesson).should be_a_new(Lesson)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested lesson" do
        ...
        Lesson.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => lesson.to_param, :lesson => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the lesson as @lesson" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Lesson.any_instance.stub(:save).and_return(false)
        put :update, {:id => lesson.to_param, :lesson => { "name" => "invalid value" }}, valid_session
        assigns(:lesson).should eq(lesson)
      end
