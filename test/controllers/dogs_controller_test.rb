...
class DogsControllerTest < ActionController::TestCase
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post :create, dog: { born_on: @dog.born_on, breed: @dog.breed, colour: @dog.colour, name: @dog.name }
    end
  ...
  test "should update dog" do
    patch :update, id: @dog, dog: { born_on: @dog.born_on, breed: @dog.breed, colour: @dog.colour, name: @dog.name }
    assert_redirected_to dog_path(assigns(:dog))
  end
